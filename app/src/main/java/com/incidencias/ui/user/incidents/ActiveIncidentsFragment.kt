...
class ActiveIncidentsFragment : Fragment(R.layout.fragment_active_incidents) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.tvScreenTitle.text = IncidentListMode.ACTIVE.screenTitle
        binding.tvScreenSubtitle.text = IncidentListMode.ACTIVE.screenSubtitle

        if (savedInstanceState == null) {
            viewModel.loadIncidents(IncidentListMode.ACTIVE)
        }
    }
