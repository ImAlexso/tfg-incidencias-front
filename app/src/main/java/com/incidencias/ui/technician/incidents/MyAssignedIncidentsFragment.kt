...
class MyAssignedIncidentsFragment : Fragment(R.layout.fragment_active_incidents) {
    ...
    private fun applyFilters() {
        ...
        val showEmpty =
            filtered.isEmpty() && !state.isLoading && state.errorMessage == null
        ...
        if (showEmpty) {
            ...
            if (filtered.isEmpty() && allIncidents.isNotEmpty()) {
                ...
                binding.emptyState.tvEmpty.text =
                    state.emptyMessage ?: "No tienes incidencias asignadas en este momento"

                binding.emptyState.tvEmptySubtitle.text =
                    "Las incidencias asignadas a tu cuenta aparecerán aquí"
            }
